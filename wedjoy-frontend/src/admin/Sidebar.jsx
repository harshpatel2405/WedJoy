...
//   FaCube, // Box cube icon
//   FaPlug, // Plug-in icon
//   FaEllipsisH, // Horizontal dots icon
...
//   {
//     name: "Forms",
//     icon: <FaList />, // List icon
//     subItems: [{ name: "Form Elements", path: "/form-elements", pro: false }],
//   },
//   {
//     name: "Tables",
//     icon: <FaTable />, // Table icon
//     subItems: [{ name: "Basic Tables", path: "/basic-tables", pro: false }],
//   },
//   {
//     name: "Pages",
//     icon: <FaFile />, // Page icon
//     subItems: [
...
// const othersItems = [
//   {
//     icon: <FaChartPie />, // Pie chart icon
//     name: "Charts",
//     subItems: [
